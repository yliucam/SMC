...
foreach(jj = 1:nrow(PARAMS)) %dopar% {
  try({
    ...
    PATH_PREFIX <-  "/nesi/project/uoa03349/postdoc/dc_melding/11_submodel/results/sub10/"
    PARAM <- PARAMS[jj,]
    sub_n <- PARAM$sub
    repN <- PARAM$rep_N
    ...
    FILENAME_SUB11 <- paste0("RES_n50_submodel11_repN", repN_s[jj], ".RData")
    FILEADDRESS_SUB9 <- paste0("/nesi/project/uoa03349/postdoc/dc_melding/11_submodel/results/sub9/", FILENAME_SUB9)
    FILEADDRESS_SUB11 <- paste0("/nesi/project/uoa03349/postdoc/dc_melding/11_submodel/results/sub11/", FILENAME_SUB11)
    ...
    out <- dc_melding_smc_sub10(data = y10,
                                out_sub9 = out9,
                                out_sub11 = out11,
                                N = 10000,
                                n_sub = 2,
